...
The 'bronze_pipeline1' project was generated by using the Lakeflow Pipelines template.

* `lib/`: Python source code for this project.
* `lib/shared`: Shared source code across all jobs/pipelines/etc.
* `resources/bronze_pipeline1_etl`: Pipeline code and assets for the bronze_pipeline1_etl pipeline.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] bronze_pipeline1_etl` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/bronze_pipeline1_etl/bronze_pipeline1_job.job.yml). The schedule
